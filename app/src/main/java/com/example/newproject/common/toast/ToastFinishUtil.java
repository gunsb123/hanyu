 ...
 * 功能：带finish的toast
 */
public class ToastFinishUtil extends Dialog {
    private static volatile ToastFinishUtil mInstance = null;
    private Context mContext;
    private Dialog mDialog;
    private TextView mTipsText;

    public ToastFinishUtil(Context context) {
    ...
    public static ToastFinishUtil getInstance(Context context) {
        mInstance = new ToastFinishUtil(context);
        return mInstance;
    }
    ...
    public void setMessage(int msg) {
        mTipsText.setText(getContext().getString(msg));
        show();
    }

    public void show() {
        mDialog.show();
        ToastTimer t = new ToastTimer(2000, 1000, mDialog, mContext, 2);
        t.start();
    }
}